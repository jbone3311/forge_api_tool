...
class UniversalSystemTester:
    ...
    def test_setup_script(self) -> bool:
        ...
        setup_script = Path(".SYSTEM/setup-new-project.py")
    ...
    def test_branch_specific_features(self) -> bool:
        ...
        try:
            ...
            test_memory_dir = Path(f".SYSTEM/memory/{test_branch}")
...
"""
    ...
    def test_mcp_tool_availability(self) -> bool:
        ...
        for tool in mcp_tools:
            try:
                if tool.startswith("@modelcontextprotocol") or tool.startswith("@executeautomation"):
                    # Node.js tool
                ...
                if result.returncode == 0 or "Usage:" in result.stdout or "Usage:" in result.stderr or "playwright" in result.stdout.lower():

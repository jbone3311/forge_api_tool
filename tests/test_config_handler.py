...
class TestConfigHandler(unittest.TestCase):
    ...
    def test_save_config_with_defaults(self):
        ...
        self.assertEqual(loaded_config["generation_settings"]["width"], 512)
        self.assertEqual(loaded_config["generation_settings"]["height"], 512)
        self.assertEqual(loaded_config["generation_settings"]["sampler"], "Euler a")
